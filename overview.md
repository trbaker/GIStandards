...
When plotting raw data on a histogram, it is apparent the total raw count of geospatial keywords by states is non-normal, producing a histogram that is right-skewed.
